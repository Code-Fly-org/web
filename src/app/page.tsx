  ...
  return (
    <>
      ...
      <div className='logo-container'>
        <div className='bg-[#5331F8] w-100 h-100 rotate-345 [animation:spin_50s_linear_infinite]'></div>
        <div className='bg-[#ED46F8] w-100 h-100 rotate-15 [animation:spin_40s_linear_infinite_reverse]'></div>
        <div className='bg-[#000000] w-70 h-70'>
